...
function setupEmailEventListeners() {
    // Email modal close on background click
...
function renderEmails(emailList) {
    ...
    // Get current user email for highlighting
    const currentUser = '{{ email }}'; // This will be replaced by template
...
// Update Email Stats
function updateEmailStats(emailList) {
    const emailCount = document.getElementById('email-count');
    if (emailCount) {
        emailCount.textContent = emailList.length;
    }
}
